...
class bicycleModel():
    ...
    def __init__(self):
        ...
        self.statePub = rospy.Publisher("/gem/model_state", Float32MultiArray, queue_size=1)
    ...
    def rearWheelModel(self, ackermannCmd):
        ...
        self.x = new_x
        self.y = new_y
        self.theta = new_theta %(np.pi*2)
        return [new_x, new_y, new_theta]

    def rearWheelFeedback(self, targetPose):
        #Gain Values
        k1 = 1
        k2 = 1
        k3 = 1
    ...
    def setModelState(self, targetState):
        control = self.rearWheelFeedback(targetState)
        a = Float32MultiArray()
        ...
        a = Float32MultiArray()
        a.data = [values[0], values[1], values[2]]
        self.statePub.publish(a)
        ...
        newState.pose.position.z = 0.236        
